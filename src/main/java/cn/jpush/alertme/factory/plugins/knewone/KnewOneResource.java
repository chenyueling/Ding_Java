 ...
 */
@Path("/knewone")
public class KnewOneResource extends BaseResource {
    private static final Logger Log = LoggerFactory.getLogger(KnewOneResource.class);
    public static final String Tag = "KnewOne";
    // 每半小时执行一次
