 ...
 */
@Path("/imooc")
public class ImoocResource extends BaseResource {
    private static final Logger Log = LoggerFactory.getLogger(ImoocResource.class);
    public static final String Tag = "IMOOC";
    // 每半小时执行一次
